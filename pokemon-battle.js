function Trainer(name, collection) {
  this.name = name;
  this.collection = collection;
}

function Pokemon(name, health, attackDmg, sound, move, type = null) {
  this.name = name;
  this.health = health;
...
function Battle(trainer1, trainer2, pokemon1, pokemon2) {
...
Battle.prototype.fight = function () {
  ...
  return `${this.notTurn.name} attacked ${this.turn.name} with ${this.notTurn.move}`
}
